...
class User(db.Model):
    ...
    real_money_wallet = db.relationship(
        'RealMoneyWallet', uselist=False, backref='user')
    ...
    def bonus_money_sum(self):
        return sum(bm.balance for bm in self.bonus_money_wallets if bm.depleted is False)
